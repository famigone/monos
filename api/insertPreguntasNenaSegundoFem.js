...
export const insertPregNenaSegundoFem = new ValidatedMethod({
  ...
  run(one) {
    ...
    var pregunta = {
      ...
      orden: 720,
      contactoid: contactoid,
      texto: "Expulsa en bloque en el segundo trismetre",
      estado: false,
      tipo: "B",
      habilitado: false,
      activo: true
    ...
    var pregunta = {
      ...
      orden: 730,
      contactoid: contactoid,
      texto: "Rompe bolsa en el segundo trismetre",
      estado: false,
      tipo: "B",
      habilitado: false,
      activo: true
    ...
    var pregunta = {
      ...
      orden: 740,
      contactoid: contactoid,
      texto: "Expulsa el feto en el segundo trismetre",
      estado: false,
      tipo: "B",
      habilitado: false,
      activo: true
    ...
    var pregunta = {
      ...
      orden: 750,
      contactoid: contactoid,
      texto: "Expulsa placenta en el segundo trismetre",
      estado: false,
      tipo: "B",
      habilitado: false,
      activo: true
